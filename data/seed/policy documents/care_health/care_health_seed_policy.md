# Care Health Insurance — Comprehensive Health Insurance Policy
...
>
> It is **not an actual Care Health Insurance policy**, does not represent official policy wording, and must not be used for purchasing, underwriting, claims, legal, or financial decisions.
>
...
|---|---:|
| Indicative Annual Premium | ₹15,984 |
| Hidden Charge Count | 1 |
| Claim Settlement Metric | 64.53% |
| Estimated Claim Volume | 10,907 |
| Prototype Complaint Rate | 0.63 |
| Sample Count | 1 |
...
```yaml
document_id: care_health_seed_policy_v1
policy_id: care_health_seed
provider: Care Health Insurance
...
It must not be interpreted as an actual insurance contract or as a representation of the terms offered by Care Health Insurance.
