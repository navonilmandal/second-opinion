# SBI General Insurance — Comprehensive Health Insurance Policy
...
>
> It is **not an actual SBI General Insurance policy**, does not represent official policy wording, and must not be used for purchasing, underwriting, claims, legal, or financial decisions.
>
...
|---|---:|
| Indicative Annual Premium | ₹8,359 |
| Hidden Charge Count | 6 |
| Claim Settlement Metric | 82.19% |
| Estimated Claim Volume | 50,602 |
| Prototype Complaint Rate | 0.44 |
| Sample Count | 1 |
...
```yaml
document_id: sbi_general_seed_policy_v1
policy_id: sbi_general_seed
provider: SBI General Insurance
...
It must not be interpreted as an actual insurance contract or as a representation of the terms offered by SBI General Insurance.
