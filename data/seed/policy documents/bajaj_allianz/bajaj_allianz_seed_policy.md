# Bajaj Allianz General Insurance — Comprehensive Health Insurance Policy
...
>
> It is **not an actual Bajaj Allianz General Insurance policy**, does not represent official policy wording, and must not be used for purchasing, underwriting, claims, legal, or financial decisions.
>
...
|---|---:|
| Indicative Annual Premium | ₹13,541 |
| Hidden Charge Count | 2 |
| Claim Settlement Metric | 87.31% |
| Estimated Claim Volume | 36,031 |
| Prototype Complaint Rate | 0.75 |
| Sample Count | 1 |
...
```yaml
document_id: bajaj_allianz_seed_policy_v1
policy_id: bajaj_allianz_seed
provider: Bajaj Allianz General Insurance
...
It must not be interpreted as an actual insurance contract or as a representation of the terms offered by Bajaj Allianz General Insurance.
